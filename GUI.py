...
def logged():
    ...
    logged_message.geometry("700x200")
    Label(logged_message, text="Welcome to Al-Quran verificator : {} ".format(username_verification.get()), fg="green", font="bold").grid(row=1,column=1,pady=20)
    Label(logged_message, text="Veuillez Tapez Le Verset A Verifier", fg="black", font=('arial', 12, 'bold')).grid(row=2,column=1,pady=20)
    Entry(logged_message, textvariable=text,width=80).grid(row=3,column=1,pady=20)
    Button(logged_message, text="Check", bg="blue", fg='white', relief="groove", font=('arial', 12, 'bold'), command=logged_destroy).grid(row=4,column=0,pady=20)
    Button(logged_message, text="Score", bg="blue", fg='white', relief="groove", font=('arial', 12, 'bold'), command=logged_destroy).grid(row=4,column=1,pady=20)
    Button(logged_message, text="Logout", bg="blue", fg='white', relief="groove", font=('arial', 12, 'bold'), command=logged_destroy).grid(row=4,column=2,pady=20)
